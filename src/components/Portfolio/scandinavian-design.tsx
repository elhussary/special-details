...
const ScandinavianDesign = () => {
  const [selectedImage, setSelectedImage] = useState(
    "/portfolio/SCANDINAVIAN/8-1.jpg"
  );

  const images = [
    "/portfolio/SCANDINAVIAN/8-1.jpg",
    "/portfolio/SCANDINAVIAN/8-2.jpg",
    "/portfolio/SCANDINAVIAN/8-3.jpg",
  ];
          ...
          <div className="space-y-12 order-1 lg:order-2">
            ...
            <div className="space-y-10 text-muted-foreground leading-relaxed">
              <p className="font-medium">
                يتميز بالبساطة ووضوح الخطوط والألوان الفاتحة (أبيض - رمادى -
                خشبى). إضاءة طبيعية وافرة وأثاث عملى. مواد طبيعية مثل الخشب
                والصوف. يناسب المساحات الصغيرة ومحبي الهدوء والراحة.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="w-7 h-7 rounded-full bg-gray-200 shadow-lg border-2 border-border"></div>
                    <div className="w-7 h-7 rounded-full bg-yellow-800 shadow-lg border-2 border-border"></div>
                  </div>
                  <p className="text-base font-medium">أبيض – رمادي – خشبي</p>
                </div>

                <div className="space-y-6">
                  <h4 className="font-bold text-foreground">المواد</h4>
                  <p className="font-medium">
                    خشب طبيعي – صوف – أقمشة بسيطة – أثاث عملى بخطوط واضحة.
                  </p>
                </div>
              </div>
              ...
              <div>
                <p className="font-semibold text-primary">
                  يناسب المساحات الصغيرة ومحبي الهدوء والراحة.
                </p>
              </div>
            </div>
          </div>
...
export default ScandinavianDesign;
