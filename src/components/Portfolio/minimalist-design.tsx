...
const MinimalistDesign = () => {
  const [selectedImage, setSelectedImage] = useState(
    "/portfolio/MINIMALIST/9-1.jpg"
  );

  const images = [
    "/portfolio/MINIMALIST/9-1.jpg",
    "/portfolio/MINIMALIST/9-2.jpg",
    "/portfolio/MINIMALIST/9-3.jpg",
    "/portfolio/MINIMALIST/9-4.jpg",
  ];
          ...
          <div className="space-y-12 order-1 lg:order-2">
            ...
            <div className="space-y-10 text-muted-foreground leading-relaxed">
              <p className="font-medium">
                يعتمد على مساحات فارغة بألوان هادئة وتنظيم عالى مع استخدام الضوء
                الطبيعى وأثاث محدود.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="w-7 h-7 rounded-full bg-black shadow-lg border-2 border-border"></div>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <p className="font-medium">
                    خامات بسيطة وموحدة – أثاث محدود بخطوط واضحة – إضاءة طبيعية.
                  </p>
                </div>
              </div>
              ...
              <div>
                <p className="font-semibold text-primary">
                  يناسب الأشخاص الذين يبحثون عن الراحة والهدوء.
                </p>
              </div>
            </div>
          </div>
