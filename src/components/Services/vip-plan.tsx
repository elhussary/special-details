    ...
    <div className="flex flex-col gap-6">
      ...
      <section className="space-y-10">
        ...
        <div className="space-y-6">
          <h5 className="font-bold">تشمل فئة VIP على:</h5>
          <ul className="space-y-4 text-sm">
            {/* البورسلين والخامات */}
            <li className="flex items-start gap-2">
              <CheckCircle2 className="text-primary w-5 h-5 mt-1" />
              <div className="leading-relaxed">
                بورسلين إسباني مستورد بمقاسات كبيرة (120×120 - 60×180 - 120×240)
                برسومات رخام طبيعية مشطوفة.
                <br />
            ...
            <li className="flex items-start gap-2">
              ...
              <div className="leading-relaxed">
                ...
                أبواب خشب طبيعي أو قشرة فاخرة (WENGE-TEAK-OAK) بمقابض
                نحاس/استانلس.
                <br />
            ...
            <li className="flex items-start gap-2">
              ...
              <div className="leading-relaxed">
                ...
                تصميم فندقي مع بانيو وجاكوزي، إضاءة مرايا، وحدات عاتمة وخزائن
                خفية.
                <br />
